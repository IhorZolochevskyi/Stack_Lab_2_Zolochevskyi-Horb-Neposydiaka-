...
namespace Lab_2
{
    ...
    {
        public static void Reverse(this string[] A)
        {
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            products[2] = new Product("Байкал", "напiй", 55);
            products[3] = new Product("Чамбо", "напiй", 44);
            products[4] = new Product("Мiвiна", "страва", 66);
            ...
            Console.WriteLine("Унiкальнi машини:");
